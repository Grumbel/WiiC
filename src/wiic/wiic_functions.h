...
WIIC_EXPORT extern int wiic_read_data(struct wiimote_t* wm, uint8_t* buffer, unsigned int offset, unsigned short len);
WIIC_EXPORT extern int wiic_write_data(struct wiimote_t* wm, unsigned int addr, uint8_t* data, uint8_t len);
